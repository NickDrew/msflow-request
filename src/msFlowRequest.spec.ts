...
describe("Testing MSFlowRequest",()=>{
    it("Expect a get operation to return valid data", async()=>{
        ...
        expect(flowResponse.remainingWorkflowULSize).to.deep.equal(validGetResponseReturn.remainingWorkflowULSize)
        expect(flowResponse.remainingWorkflowWrites).to.deep.equal(validGetResponseReturn.remainingWorkflowWrites)
    ...
    it("Expect a post to send valid data", async()=>{
        ...
        expect(flowResponse.correlationID).to.deep.equal(validPostyResponseReturn.correlationID)
        expect(flowResponse.data).to.deep.equal(validPostyResponseReturn.data)
        expect(flowResponse.executionLocation).to.deep.equal(validPostyResponseReturn.executionLocation)
        expect(flowResponse.remainingAPIRequests).to.deep.equal(validPostyResponseReturn.remainingAPIRequests)
        expect(flowResponse.remainingWorkflowDLSize).to.deep.equal(validPostyResponseReturn.remainingWorkflowDLSize)
        expect(flowResponse.remainingWorkflowReads).to.deep.equal(validPostyResponseReturn.remainingWorkflowReads)
        expect(flowResponse.remainingWorkflowULSize).to.deep.equal(validPostyResponseReturn.remainingWorkflowULSize)
        expect(flowResponse.remainingWorkflowWrites).to.deep.equal(validPostyResponseReturn.remainingWorkflowWrites)
        expect(flowResponse.requestDateTime).to.deep.equal(validPostyResponseReturn.requestDateTime)
        expect(flowResponse.requestID).to.deep.equal(validPostyResponseReturn.requestID)
        expect(flowResponse.trackingID).to.deep.equal(validPostyResponseReturn.trackingID)
        expect(flowResponse.triggerHistoryName).to.deep.equal(validPostyResponseReturn.triggerHistoryName)
        expect(flowResponse.workflowID).to.deep.equal(validPostyResponseReturn.workflowID)
        expect(flowResponse.workflowName).to.deep.equal(validPostyResponseReturn.workflowName)
        expect(flowResponse.workflowRunID).to.deep.equal(validPostyResponseReturn.workflowRunID)
